function [M] = MovieOf_SphericalHarmonics_As_Chargewaves(l,m)
...
% Imaginary Part
%r3 = OscillationRadius*diag(diag(Ylm))*cos(w*t)*ones(AngleDivision,AngleDivision)*(diag(diag(sin(m*theata)))) + InitialRadius*ones(AngleDivision,AngleDivision);
